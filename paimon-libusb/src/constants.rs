...
// libusb_hotplug
pub const LIBUSB_HOTPLUG_NO_FLAGS: libusb::libusb_hotplug_flag = 0;
pub const LIBUSB_HOTPLUG_ENUMERATE: libusb::libusb_hotplug_flag = 1 << 0;
pub const LIBUSB_HOTPLUG_EVENT_DEVICE_ARRIVED: libusb::libusb_hotplug_event = 0x01;
pub const LIBUSB_HOTPLUG_EVENT_DEVICE_LEFT: libusb::libusb_hotplug_event = 0x02;
...
// libusb_log_cb_mode
pub const LIBUSB_LOG_CB_GLOBAL: libusb::libusb_log_cb_mode = 1 << 0;
pub const LIBUSB_LOG_CB_CONTEXT: libusb::libusb_log_cb_mode = 1 << 1;

pub const LIBUSB_CONTROL_SETUP_SIZE: usize = std::mem::size_of::<libusb::libusb_control_setup>();