...
impl fmt::Debug for ConfigDescriptor {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> Result<(), fmt::Error> {
        ...
        let descriptor: &libusb::libusb_config_descriptor = unsafe { &*self.descriptor };
...
#[doc(hidden)]
pub(crate) unsafe fn from_libusb(config: *const libusb::libusb_config_descriptor) -> ConfigDescriptor {
